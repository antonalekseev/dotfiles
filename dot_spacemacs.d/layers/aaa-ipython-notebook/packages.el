...
(setq aaa-ipython-notebook-packages
      '(
        ein
        ob-ipython
        ))

(defun aaa-ipython-notebook/init-ein ()
  (use-package ein
    :defer t
    ...
    (progn
      ...
      (spacemacs|define-transient-state aaa-ipython-notebook
 ...
 [_RET_]^^^^     execute"
        ...
        :bindings
        ("q" nil :exit t)
        ("?" spacemacs//aaa-ipython-notebook-ms-toggle-doc)
        ("h" ein:notebook-worksheet-open-prev-or-last)
        ("j" ein:worksheet-goto-next-input)
        ("k" ein:worksheet-goto-prev-input)
        ("l" ein:notebook-worksheet-open-next-or-first)
...
(defun aaa-ipython-notebook/pre-init-ob-ipython ()
  (spacemacs|use-package-add-hook org
    :post-config
    (use-package ob-ipython
      :init (add-to-list 'org-babel-load-languages '(ipython . t)))))

(defun aaa-ipython-notebook/init-ob-ipython ())
